...
// LLM-legible error.
func (v *WorkspaceVerbs) Fork(ctx context.Context, namespace, srcWorkspace, srcRevision, dstWorkspace string) (*v1alpha1.WorkspaceRevision, error) {
	...
	if parent.Status.Phase != v1alpha1.WorkspaceRevisionCommitted || cas.Digest(parent.Spec.ContentManifest).Validate() != nil {
		return nil, &RejectionError{
	...
	rev := &v1alpha1.WorkspaceRevision{
		...
		Spec: v1alpha1.WorkspaceRevisionSpec{
			WorkspaceRef: v1alpha1.LocalObjectReference{Name: dstWorkspace},
			Source: v1alpha1.RevisionSource{FromWorkspaceRevision: &v1alpha1.WorkspaceRevisionRef{
...
func (v *WorkspaceVerbs) Revert(ctx context.Context, namespace, workspace, targetRevision string) (*v1alpha1.WorkspaceRevision, error) {
