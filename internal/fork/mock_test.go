...
func TestMockEngine_CreateTemplate(t *testing.T) {
	...
	if err := engine.CreateTemplate("python", "python:3.12-slim", nil, nil, nil); err != nil {
...
func TestMockEngine_CapacityReportsTotalAndEstimate(t *testing.T) {
	engine := NewMockEngine()
	engine.CreateTemplate("python", "python:3.12-slim", nil, nil, nil)
...
func TestMockForkRunning(t *testing.T) {
	e := NewMockEngine()
	e.ForkDelay = 0
	if err := e.CreateTemplate("py", "python:3.12-slim", nil, nil, nil); err != nil {
		t.Fatal(err)
	}
